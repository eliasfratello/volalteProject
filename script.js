...
const translations = {
    es: {
        ...
        about_desc: "La recolección de neumáticos usados Barcelona es el servicio principal de <strong>Volalte</strong>. Ofrecemos soluciones rápidas, legales y seguras para talleres, exportadores y entidades públicas.",
        // Services
        ...
        // Footer
        footer_about: "Sobre Nosotros", footer_about_text: "En Volalte, creemos que cuidar el planeta no debería ser un lujo, sino una responsabilidad compartida.",
        ...
        footer_subscribe: "Suscribirse", footer_copyright: "© 2025 Volalte. Todos los derechos reservados.",
        // Services Page
        ...
        serv_hero_text3: "Con Volalte lo tienes todo: experiencia, logística y compromiso ambiental.",
        ...
        serv_cta_title: "¿Eres taller, municipio o revendedor internacional?", serv_cta_desc: "En Volalte tenemos soluciones adaptadas a cada cliente. Nuestro equipo está listo para ayudarte con logística, precios y cumplimiento normativo.",
        serv_cta_btn: "Solicitar Presupuesto",
        why_title: "¿Por Qué Elegir a Volalte?", why1_title: "Soluciones a Medida", why1_desc: "Adaptamos nuestros servicios según tus necesidades: volumen, frecuencia y destino.",
        ...
        // About Page
        about_hero_title: "Sobre Nosotros", about_hero_desc: "Conoce la historia, misión y valores de Volalte. Somos tu partner de confianza en la gestión sostenible de neumáticos usados en España.",
        about_history_badge: "Nuestra Historia", about_history_title: "Convertimos residuos en oportunidades",
        about_history_p1: "En <strong>Volalte</strong>, creemos que cuidar el planeta no debería ser un lujo, sino una responsabilidad compartida — accesible, práctica y rentable para todos los negocios.",
        ...
        about_history_p3: "Fundamos Volalte con una misión clara: <strong>transformar el problema de los neumáticos fuera de uso en una oportunidad de negocio sostenible</strong>.",
        ...
        about_why_title: "¿Por qué elegir Volalte?", about_why_desc: "Nos diferenciamos por nuestra experiencia, compromiso y resultados tangibles.",
        ...
        about_cta_title: "¿Listo para trabajar con nosotros?", about_cta_desc: "Únete a los más de 5.000 talleres que ya confían en Volalte.",
        ...
        dist_why_title: "¿Por Qué Ser Distribuidor de Volalte?", dist_why_desc: "Accede a ventajas exclusivas que te ayudarán a hacer crecer tu negocio de forma sostenible.",
    ...
    ca: {
        ...
        about_desc: "La recollida de pneumàtics usats Barcelona és el servei principal de <strong>Volalte</strong>. Oferim solucions ràpides, legals i segures per a tallers, exportadors i entitats públiques.",
        ...
        footer_about: "Sobre Nosaltres", footer_about_text: "A Volalte, creiem que cuidar el planeta no hauria de ser un luxe, sinó una responsabilitat compartida.",
        ...
        footer_copyright: "© 2025 Volalte. Tots els drets reservats.",
        ...
        serv_hero_text3: "Amb Volalte ho tens tot: experiència, logística i compromís ambiental.",
        ...
        serv_cta_title: "Ets taller, municipi o revenedor internacional?", serv_cta_desc: "A Volalte tenim solucions adaptades a cada client.",
        serv_cta_btn: "Sol·licitar Pressupost",
        why_title: "Per Què Triar Volalte?", why1_title: "Solucions a Mida", why1_desc: "Adaptem els nostres serveis segons les teves necessitats.",
        ...
        about_hero_title: "Sobre Nosaltres", about_hero_desc: "Coneix la història, missió i valors de Volalte.",
        about_history_badge: "La Nostra Història", about_history_title: "Convertim residus en oportunitats",
        about_history_p1: "A <strong>Volalte</strong>, creiem que cuidar el planeta no hauria de ser un luxe, sinó una responsabilitat compartida.",
        ...
        about_history_p3: "Vam fundar Volalte amb una missió clara: <strong>transformar el problema dels pneumàtics fora d'ús en una oportunitat de negoci sostenible</strong>.",
        ...
        about_why_title: "Per què triar Volalte?", about_why_desc: "Ens diferenciem per la nostra experiència, compromís i resultats tangibles.",
        ...
        about_cta_title: "Preparat per treballar amb nosaltres?", about_cta_desc: "Uneix-te als més de 5.000 tallers que ja confien en Volalte.",
        ...
        dist_why_title: "Per Què Ser Distribuïdor de Volalte?", dist_why_desc: "Accedeix a avantatges exclusius per fer créixer el teu negoci.",
    ...
    fr: {
        ...
        about_desc: "La collecte de pneus usagés à Barcelone est le service principal de <strong>Volalte</strong>. Nous offrons des solutions rapides, légales et sûres.",
        ...
        footer_about: "À Propos de Nous", footer_about_text: "Chez Volalte, nous croyons que prendre soin de la planète ne devrait pas être un luxe.",
        ...
        footer_copyright: "© 2025 Volalte. Tous droits réservés.",
        ...
        serv_hero_text3: "Avec Volalte vous avez tout: expérience, logistique et engagement environnemental.",
        ...
        serv_cta_title: "Vous êtes atelier, municipalité ou revendeur international?", serv_cta_desc: "Chez Volalte nous avons des solutions adaptées à chaque client.",
        serv_cta_btn: "Demander un Devis",
        why_title: "Pourquoi Choisir Volalte?", why1_title: "Solutions Sur Mesure", why1_desc: "Nous adaptons nos services selon vos besoins.",
        ...
        about_hero_title: "À Propos de Nous", about_hero_desc: "Découvrez l'histoire, la mission et les valeurs de Volalte.",
        about_history_badge: "Notre Histoire", about_history_title: "Nous transformons les déchets en opportunités",
        about_history_p1: "Chez <strong>Volalte</strong>, nous croyons que prendre soin de la planète ne devrait pas être un luxe, mais une responsabilité partagée.",
        ...
        about_history_p3: "Nous avons fondé Volalte avec une mission claire: <strong>transformer le problème des pneus usagés en une opportunité commerciale durable</strong>.",
        ...
        about_why_title: "Pourquoi choisir Volalte?", about_why_desc: "Nous nous distinguons par notre expérience, notre engagement et nos résultats tangibles.",
        ...
        about_cta_title: "Prêt à travailler avec nous?", about_cta_desc: "Rejoignez les plus de 5.000 ateliers qui font confiance à Volalte.",
        ...
        dist_why_title: "Pourquoi Devenir Distributeur Volalte?", dist_why_desc: "Accédez à des avantages exclusifs pour développer votre entreprise.",
    ...
    en: {
        ...
        about_desc: "Used tire collection in Barcelona is the main service of <strong>Volalte</strong>. We offer fast, legal and safe solutions for workshops, exporters and public entities.",
        ...
        footer_about: "About Us", footer_about_text: "At Volalte, we believe that caring for the planet should not be a luxury, but a shared responsibility.",
        ...
        footer_copyright: "© 2025 Volalte. All rights reserved.",
        ...
        serv_hero_text3: "With Volalte you have it all: experience, logistics and environmental commitment.",
        ...
        serv_cta_title: "Are you a workshop, municipality or international reseller?", serv_cta_desc: "At Volalte we have solutions adapted to each client.",
        serv_cta_btn: "Request Quote",
        why_title: "Why Choose Volalte?", why1_title: "Custom Solutions", why1_desc: "We adapt our services to your needs.",
        ...
        about_hero_title: "About Us", about_hero_desc: "Learn about the history, mission and values of Volalte.",
        about_history_badge: "Our History", about_history_title: "We turn waste into opportunities",
        about_history_p1: "At <strong>Volalte</strong>, we believe that caring for the planet should not be a luxury, but a shared responsibility.",
        about_history_p2: "Our story was born from an urgent need: every year, millions of tires reach end of life in Spain.",
        about_history_p3: "We founded Volalte with a clear mission: <strong>transform the problem of end-of-life tires into a sustainable business opportunity</strong>.",
        ...
        about_why_title: "Why choose Volalte?", about_why_desc: "We stand out for our experience, commitment and tangible results.",
        ...
        about_cta_title: "Ready to work with us?", about_cta_desc: "Join the over 5,000 workshops that already trust Volalte.",
        ...
        dist_why_title: "Why Become a Volalte Distributor?", dist_why_desc: "Access exclusive benefits to grow your business sustainably.",
...
console.log('%c Volalte ', 'background:#2E7D32;color:white;padding:10px 20px;font-size:16px;font-weight:bold');
